    ...
    $(document).ready(function () {
        ...
        $('#teacherForm').submit(function () {
            ...
            var empID = $(this).find('input[name="empID"]').val();

            var terrors = [];
            

            if (!empID.trim()) {
                terrors.push('Employee ID is required.');
                $('#terror-empID').text('This is required.');
            } else if (!isValidEmpID(empID)) {
                terrors.push('Invalid Employee ID.');
                $('#terror-empID').text('Invalid Employee ID.');
            } else {
                $('#terror-empID').text('');
            }
